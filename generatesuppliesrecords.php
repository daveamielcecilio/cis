...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 10, 'Inventory Records', 0, 1, 'C');
        $this->Ln(10);
...
header('Content-Disposition: attachment; filename="inventory_records.pdf"');
...
$pdf->Output('I', 'inventory_records.pdf'); // Output to view and download
exit;
?>
